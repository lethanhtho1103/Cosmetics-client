import { Box, Typography, Button, Tabs, Tab, Card, CardContent, Grid } from '@mui/material';
  ...
  return (
    <Box sx={{ padding: '0px 20px 20px' }}>
      {/* <>
        ...
        <div className="data-empty">Bạn chưa có đơn hàng nào.</div>
            ...
            <CardContent>
              <Grid container>
                <Grid
                  ...
                  sx={{ padding: 0, borderBottom: '1px solid #e0e0e0', paddingBottom: '12px' }}
                >
                ...
                <Grid
                  ...
                  xs={12}
                  container
                  sx={{ borderBottom: '1px solid #e0e0e0', paddingBottom: '12px', marginTop: '12px' }}
                >
                  <Grid item xs={12} md={2}>
                    <img
                      src="https://www.guardian.com.vn/media/catalog/product/cache/30b2b44eba57cd45fd3ef9287600968e/t/h/thumbnail_3017868_x8cuxggdltlu51m1.jpg"
                      alt="Product"
                  ...
                  <Grid item xs={12} md={10}>
                    <Typography variant="body1" sx={{ fontWeight: 500, width: '90%' }}>
                      Suntaiho cáp sạc 2.4A USB IP dây sạc nhanh 1m 2m Cáp truyền dữ liệu chính hãng Cho iphone ipad
                      airpods ipod
                    </Typography>
                    <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                      ...
                      >
                        Số lượng: <Typography sx={{ color: '#000', fontWeight: 500, ml: '4px' }}>x1</Typography>
                      </Typography>
                ...
                <Grid item xs={12} sx={{ textAlign: 'right', paddingTop: '10px', marginTop: '10px' }}>
                  <Typography
                    variant="body1"
                    sx={{
                      color: 'red',
                  ...
                  >
                    ...
                    <span style={{ color: 'black', margin: '0 4px' }}>Thành tiền:</span> ₫25.000
                  </Typography>
                  <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                    <Typography
                      variant="body2"
